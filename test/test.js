...
describe('# Operations', () => {
  ...
  describe('CubeSummation', () => {
    it('should pass the specific test', () => {
      const testCase = '2\n4 5\nUPDATE 2 2 2 4\nQUERY 1 1 1 3 3 3\nUPDATE 1 1 1 23\nQUERY 2 2 2 4 4 4\nQUERY 1 1 1 3 3 3\n2 4\nUPDATE 2 2 2 1\nQUERY 1 1 1 1 1 1\nQUERY 1 1 1 2 2 2\nQUERY 2 2 2 2 2 2';
      const expectedResult = '4\n4\n27\n0\n1\n1';
      assert.equal(op.cubeSummation(testCase), expectedResult);
    });
    it('should not accept less operations than the needed', () => {
      const testCase = '2\n4 5\nUPDATE 2 2 2 4\nQUERY 1 1 1 3 3 3\nUPDATE 1 1 1 23\nQUERY 2 2 2 4 4 4\nQUERY 1 1 1 3 3 3';
      assert.throws(()=>{
        op.cubeSummation(testCase);
      } , Error);
    });
  });
});
